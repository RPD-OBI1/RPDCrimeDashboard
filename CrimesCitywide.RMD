...
source("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Functions/guntablenest.R")
source("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Functions/kerntorast.R")
source("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Functions/hotspotMap.R")
source("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Functions/hotspotMapSV.R")
...
beatNames <- readRDS(file = "//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/beatNames.RDS")
...
PropVals <- read.csv("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/ProportionsAndCountsCityWide.csv", 
                     header= T)
ShootingControlLimits <- read.csv("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/3YrWeightedControlLimitsShootingsCityWide.csv")
ShootingProps <- read.csv("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/ProportionsAndCountsShootingsCityWide.csv", 
                          stringsAsFactors = FALSE)

histdata <- read.csv(file = "//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/historicaldataCityWide.csv", 
                     stringsAsFactors = FALSE, 
                     header = TRUE)

controllimits <- read.csv(file = "//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/3YrWeightedControlLimitsCityWide.csv", 
                          header = TRUE)
...
![](//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/ReferenceTreeMap.png)
...
![](//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/ReferenceProjectionPlot.png)
