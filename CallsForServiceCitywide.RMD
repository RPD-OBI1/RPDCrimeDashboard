...
source("//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Functions/cfsHotspotMap2.R")
...
cfs.df <- readRDS(file = "//cor.local/RPD/Chief/OBI/Projects/dashboard/RPDCrimeDashboard/Objects/citywidecfs.RDS")
