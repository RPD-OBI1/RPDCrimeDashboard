...
#trying parameterized rmarkdown reports: http://rmarkdown.rstudio.com/developer_parameterized_reports.html
...
wait <- ggplot(waittime, 
               aes(x = CallTypeCode, y = MedianWaitTime, size = Count, color = RPD_Priority)) +
    geom_point() +
    theme_bw() +
...
ggplotly(wait, tooltip = c("CallTypeCode", "Count", "MedianWaitTime"))
```
