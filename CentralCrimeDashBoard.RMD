...
The action limit chart shows the cumulative weekly values experienced to date for the current year. Points in black show values that follow the expected accumulation path. Points in green are lower than expected and points in red are higher than expected. The blue shaded region refers to the expected path to result in a value between the year-end action limits.

The black points on the chart at week 53 show the results of our simulations, estimating where RPD’s stats will be at year-end. The large blue dot shows the average of those simulations. The X shows the weighted average year-end totals for the past three years.
